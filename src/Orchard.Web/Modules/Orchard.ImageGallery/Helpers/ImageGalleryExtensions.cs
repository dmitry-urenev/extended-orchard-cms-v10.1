...
namespace Orchard.ImageGallery.Helpers
{
    ...
    {
        public static HtmlString Image(this HtmlHelper helper, GalleryImagePart image)
        {
        ...
        public static HtmlString ImageWithThumbnailSize(this HtmlHelper helper, GalleryImagePart image)
        {
            return new HtmlString(string.Empty);
